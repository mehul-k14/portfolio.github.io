...
var typed = new Typed(".typing", {
    strings: ["OOPs", "Algorithm Design", "REST APIs", "MVC Architecture", "Multithreading", "Software Design Principles", "ZeroMQ", "Image Processing"],
    typeSpeed: 100,
    BackSpeed: 80,
    loop: true
})
...
function sendMail() {
    emailjs.init('QSlQG4mSb1USK9M0N');
    var params = {
    ...
    const serviceID = "service_exncw1h";
    const templateID = "template_9nnxlae";
